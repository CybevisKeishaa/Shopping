...
public class listUser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Customer_User> list = c.getAll(pageNumber, PAGE_SIZE);
        int totalProducts = c.getToltalCustomer();
        int totalPages = (int) Math.ceil(totalProducts / (double) PAGE_SIZE);
        request.setAttribute("currentPage", pageNumber);
        request.setAttribute("totalPages", totalPages);
        request.setAttribute("data", list);
        request.getRequestDispatcher("../view/ad/userList.jsp").forward(request, response);
    } 
