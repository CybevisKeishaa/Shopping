...
<html lang="en">
    ...
    <body>
        ...
        <script>
             function pay() {
              window.location.href = "${pageContext.request.contextPath}/vnpay_jsp/vnpay_pay.jsp";
            }
            function querydr() {
              window.location.href = "${pageContext.request.contextPath}/vnpay_jsp/vnpay_querydr.jsp";
            }
             function refund() {
              window.location.href = "${pageContext.request.contextPath}/vnpay_jsp/vnpay_refund.jsp";
            }
        </script>
    </body>
</html>
