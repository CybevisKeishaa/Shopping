                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach var="item" items="${cart.items}">
                                                        <tr>                        
                                                            ...
                                                            <td><fmt:formatNumber value="${item.capacity.unit_price}" type="currency" currencySymbol="VND"></fmt:formatNumber></td>
                                                                <td>
                                                        ...
                                                        <c:set var="totalPrice" value="${totalPrice + (item.quantity * item.capacity.unit_price)}"></c:set>  
                                                    </c:forEach>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <span id="total_order_price">
                                                                <fmt:formatNumber value="${totalPrice}" type="currency" currencySymbol="VND"></fmt:formatNumber>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
