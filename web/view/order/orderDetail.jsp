<%-- Document : orderDetail.jsp Created on : Oct 3, 2024, 2:08:07 PM Author : KEISHA --%>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <c:forEach var="product" items="${requestScope.products}">
                            <tr>
                                <td>
                                    <img src="${pageContext.request.contextPath}/img/${product.img[0].img_url}"
                                         width="100">
                                </td>
                                <td>${product.name}</td>
                                ...
                                <td>
                                    ...
                                    <c:if test="${requestScope.order.status.status_id == 4}">
                                        <form action="../feedback" method="GET">
                                            ...
                                            <button type="submit"
                                                    class="btn btn-secondary btn-sm">Feedback</button>
                                        </form>
                                    </c:if>
                                </td>
                            </tr>
