                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="viewOrderDetails?product_id=${i.product_id}">
                                                ...
                                                <div class="product-content">
                                                    <h3><a href="viewOrderDetails?product_id=${i.product_id}">${i.name}</a></h3>
        ...
        <div class="pagination-container d-flex justify-content-center">
            <div class="pagination">
                ...
                <c:if test="${currentPage > 1}">
                    <a href="viewOrderDetails?page=${currentPage - 1}" class="prev">&lt;</a>
                </c:if>
                ...
                <c:forEach var="i" begin="1" end="${totalPages}">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="viewOrderDetails?page=${i}">${i}</a>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:if test="${currentPage < totalPages}">
                    <a href="viewOrderDetails?page=${currentPage + 1}" class="next">&gt;</a>
                </c:if>
            </div>
        </div>
    </div>
