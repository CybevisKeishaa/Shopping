                ...
                <div class="col-lg-8 col-12">
                    <div class="blog-single-main">
                        <div class="row">
                            <div class="col-12">
                                <div class="image">
                                    <img class="blog-image" src="${pageContext.request.contextPath}/img/${requestScope.data.image[0].img_url}"  alt="#">
                                </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        <div class="single-widget search">
                            <form action="blogSearch" class="search-bar">
                                <input name="search" autocomplete="off"  placeholder="Search Blog Here....." type="search">
