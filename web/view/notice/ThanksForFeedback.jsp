<%-- 
    Document   : ThanksForFeedback
    Created on : Oct 7, 2024, 10:37:52 PM
    Author     : KEISHA
--%>
    ...
    <body>
        ...
        <div class="page-container">
            <div class="thank-you-container">
                <h1>Cảm ơn bạn!</h1>
                <p>Cảm ơn bạn đã dành thời gian feedback cho chúng tôi, những đóng góp của bạn sẽ giúp chúng tôi hoàn thiện hơn về trang web của mình</p>
